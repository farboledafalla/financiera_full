...
export default function Sidebar({ open, setOpen }) {
  ...
  return (
    <div className={`fixed inset-y-0 left-0 z-30 w-64 bg-white shadow-lg transform ${open ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out md:translate-x-0`}>
      <div className="flex flex-col h-full">
        <div className="h-16 flex items-center justify-center border-b">
          <h1 className="text-xl font-bold text-primary-600">Financiera Alternativa</h1>
        </div>
